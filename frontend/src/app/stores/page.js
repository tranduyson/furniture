        ...
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mx-auto text-center">
            <div className="flex items-center justify-center gap-3 mb-4">
              <div className="w-8 h-[1px] bg-[#b8860b]"/><span className="text-[#b8860b] text-xs font-bold uppercase tracking-[0.25em] font-sans">TRẢI NGHIỆM TRỰC TIẾP</span><div className="w-8 h-[1px] bg-[#b8860b]"/>
            </div>
            <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900 mb-4 font-serif leading-tight">Ghé Thăm Showroom SONDT</h2>
            <p className="text-gray-500 text-base md:text-lg max-w-2xl mx-auto leading-relaxed">Hệ thống showroom hiện đại trưng bày các bộ sưu tập nội thất mới nhất của chúng tôi. Hãy đến và cảm nhận trực tiếp chất lượng hoàn thiện đẳng cấp.</p>
          </div>
        </div>
      </section>
